...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UiImageViewerImp_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(1, 17, 12), // "DragFileName"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 10), // "p_FileName"
QT_MOC_LITERAL(4, 42, 15) // "OnClickFileName"

    },
    "UiImageViewerImp\0DragFileName\0\0"
    "p_FileName\0OnClickFileName"
};
...
void UiImageViewerImp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        UiImageViewerImp *_t = static_cast<UiImageViewerImp *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->DragFileName((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->OnClickFileName((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (UiImageViewerImp::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UiImageViewerImp::DragFileName)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject UiImageViewerImp::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_UiImageViewerImp.data,
...
void *UiImageViewerImp::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UiImageViewerImp.stringdata0))
...
// SIGNAL 0
void UiImageViewerImp::DragFileName(const QString & _t1)
{
